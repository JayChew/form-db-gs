...
// ToFormModel converts CreateFormRequest to FormModel
func (req CreateFormRequest) ToFormModel() FormModel {
	return FormModel{
		...
		LastSubmission:  req.LastSubmission,
		FormTime:        req.FormTime,
		Category:        req.Category,
		Tags:            req.Tags,
		StrongURL:       req.StrongURL,
